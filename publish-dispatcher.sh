...
docker run -d -e RUNMODE=$1 --rm -v aem632-publish:/crx-quickstart/repository -v /aem632-publish/logs:/crx-quickstart/logs -p 4503:4503 -p 8001:8001 jmc22071983/aem632-publish:0.0.4-SNAPSHOT 
